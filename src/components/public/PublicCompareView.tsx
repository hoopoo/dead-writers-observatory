...
export function PublicCompareView(props: { result: PublicObservation }) {
  ...
  if (summary.allInsufficient) {
    return (
      <section className="public-compare">
        <h2>3人が見た場所</h2>
        <p className="public-compare__silence">
          {summary.insufficientNotice ??
